...
class Home extends React.Component{
  ...
  componentDidMount(){
    ...
    .then(response => {
      ...
      this.setState({videourl1 : response.data[0].url});
      this.setState({videourl2 : response.data[1].url});
      this.setState({videourl3 : response.data[2].url});
      this.setState({videourl4 : response.data[3].url});
      this.setState({videourl5 : response.data[4].url});
      this.setState({videourl6 : response.data[5].url});
      this.setState({videotitle1 : response.data[0].title});
      this.setState({videotitle2 : response.data[1].title});
      this.setState({videotitle3 : response.data[2].title});
      this.setState({videotitle4 : response.data[3].title});
      this.setState({videotitle5 : response.data[4].title});
      this.setState({videotitle6 : response.data[5].title});
      this.setState({videotag1 : response.data[0].category});
      this.setState({videotag2 : response.data[1].category});
      this.setState({videotag3 : response.data[2].category});
      this.setState({videotag4 : response.data[3].category});
      this.setState({videotag5 : response.data[4].category});
      this.setState({videotag6 : response.data[5].category});
      this.setState({videodesc1 : response.data[0].overView});
      this.setState({videodesc2 : response.data[1].overView});
      this.setState({videodesc3 : response.data[2].overView});
      this.setState({videodesc4 : response.data[3].overView});
      this.setState({videodesc5 : response.data[4].overView});
      this.setState({videodesc6 : response.data[5].overView});
        // catchでエラー時の挙動を定義する
    }).catch(err => {
        console.log('err:', err);
    });
    ...
    return (
      <Homebody>
        ...
        <Homeimgdiv0 id={'homeimgdiv0'}>
          <video width="100%" height="100%" src={this.state.videourl1} controls></video>
          <Infodiv id={'infodiv0'}>
            <Maskimg src={imagemask}/>
            <Userimg src={imageuser}/>
            <Homeptitle>{this.state.videotitle1}</Homeptitle>
            <Homeptag>{this.state.videotag1}</Homeptag>
            <Homepdesc>{this.state.videodesc1}</Homepdesc>
          </Infodiv>
        </Homeimgdiv0>
        <Homeimgdiv1 id={'homeimgdiv1'}>
          <video width="100%" height="100%" src={this.state.videourl2} controls></video>
          <Infodiv id={'infodiv1'}>
            <Maskimg src={imagemask}/>
            <Userimg src={imageuser}/>
            <Homeptitle>{this.state.videotitle2}</Homeptitle>
            <Homeptag>{this.state.videotag2}</Homeptag>
            <Homepdesc>{this.state.videodesc2}</Homepdesc>
          </Infodiv>
        </Homeimgdiv1>
        <Homeimgdiv2 id={'homeimgdiv2'}>
        <video width="100%" height="100%" src={this.state.videourl3} controls></video>
          <Infodiv id={'infodiv2'}>
            <Maskimg src={imagemask}/>
            <Userimg src={imageuser}/>
            <Homeptitle>{this.state.videotitle3}</Homeptitle>
            <Homeptag>{this.state.videotag3}</Homeptag>
            <Homepdesc>{this.state.videodesc3}</Homepdesc>
          </Infodiv>
        </Homeimgdiv2>
        <Homeimgdiv3 id={'homeimgdiv3'}>
        <video width="100%" height="100%" src={this.state.videourl4} controls></video>
          <Infodiv id={'infodiv3'}>
            <Maskimg src={imagemask}/>
            <Userimg src={imageuser}/>
            <Homeptitle>{this.state.videotitle4}</Homeptitle>
            <Homeptag>{this.state.videotag4}</Homeptag>
            <Homepdesc>{this.state.videodesc4}</Homepdesc>
          </Infodiv>
        </Homeimgdiv3>
        <Homeimgdiv4 id={'homeimgdiv4'}>
        <video width="100%" height="100%" src={this.state.videourl5} controls></video>
          <Infodiv id={'infodiv4'}>
            <Maskimg src={imagemask}/>
            <Userimg src={imageuser}/>
            <Homeptitle>{this.state.videotitle5}</Homeptitle>
            <Homeptag>{this.state.videotag5}</Homeptag>
            <Homepdesc>{this.state.videodesc5}</Homepdesc>
          </Infodiv>
        </Homeimgdiv4>
        <Homeimgdiv5 id={'homeimgdiv5'}>
          <video width="100%" height="100%" src={this.state.videourl6} controls></video>
          <Infodiv id={'infodiv5'}>
            <Maskimg src={imagemask}/>
            <Userimg src={imageuser}/>
            <Homeptitle>{this.state.videotitle6}</Homeptitle>
            <Homeptag>{this.state.videotag6}</Homeptag>
            <Homepdesc>{this.state.videodesc6}</Homepdesc>
          </Infodiv>
        </Homeimgdiv5>
      </Homebody>
    );
